...
<body>
    ...
    <div class="sidebar transition">
         <div class="logo">
            <img src="https://img.icons8.com/color/48/000000/book.png" class="p-4"/>
            <h4 class="text-left">Perpustakaan Masyarakat</h4>
        </div>
        ...
        <ul>
                ...
                <li>
                    ...
                    data-bs-target="#starter-layout" aria-expanded="false">
                ...
                <li>
                    <a href="#" data-bs-toggle="collapse"
                    data-bs-target="#starter-bootstrap" aria-expanded="false">
                            <i class="las la-th"></i>
